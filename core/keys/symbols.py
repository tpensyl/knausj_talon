...
symbols = [
    ...
    Symbol("+", None, ["plus"]),
    Symbol("~", None, ["tilde"]),
    Symbol("_", None, ["down score", "underscore", "sub"]),
    Symbol("(", ["paren", "left paren"], None),
    Symbol(")", ["right paren", "close paren"], None),
    Symbol("[", None,["square", "L square", "left square",],),
    Symbol("]", None, ["right square", "close square"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash", "fake"]),
    Symbol("{", None, ["brace", "left brace", "curly brace", "left curly brace"],),
    Symbol("}", None, ["right brace","right curly brace", "close brace"]),
    Symbol("<", None, ["angle", "left angle", "less than"]),
    Symbol(">", None, ["right angle", "close angle", "greater than"]),
    Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
