...
class MouseSnapMillion:
    def __init__(self):
        ...
        self.saved_label_transparency = int(setting_label_transparency.get(), 16)
        self.saved_bg_transparency = int(setting_superblock_transparency.get(), 16)
        self.field_size = 20 
    ...
    def setup(self, *, rect: Rect = None, screen_num: int = None):
        ...
        self.rulers = False
        self.checkers = False
        self.pattern = dense_grid_startup_mode.get()
